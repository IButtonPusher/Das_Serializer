...
&lt;/DeployedStat&gt;");
		...
		public void TimespanXml()
		{
			...
			//Assert.IsTrue(dyn.StartedAt == int2);
		}
		...
		public void GdiColorInferredXml()
		{
			...
			Assert.IsTrue(clr.R == yeti.R && clr.G == yeti.G && clr.B == yeti.B);
		}
		...
		public void ClassWithDictionaryXml()
		{
			...
			if (mc1.Dic.Count != mc2.Dic.Count)
				Assert.IsFalse(true);
			Assert.IsTrue(Serializer.ToXml(mc2) == xml);
		}
...
//			Assert.IsTrue(vvq.Id == res.Id && vvq.Name == res.Name &&
