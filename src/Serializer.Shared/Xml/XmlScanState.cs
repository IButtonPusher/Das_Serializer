...
public sealed partial class XmlExpress2
{
                                           ...
                                           ref NodeScanState scanState)
   {
      ...
      switch (scanState)
      {
         ...
         case NodeScanState.AttributeValueRead:
            ...
            GetUntilAny(ref currentIndex, txt, stringBuilder,
               _attributeNameSplitters, out currentChar);
                                           ...
                                           ref NodeScanState scanState)
   {
      ...
      switch (scanState)
      {
         ...
         case NodeScanState.JustOpened:
            ...
            if (currentChar == '!')
            {
               ...
               return AdvanceScanState(txt, ref currentIndex,  ref scanState);
            }
         ...
         case NodeScanState.AttributeValueRead:
            ...
            GetUntilAny(ref currentIndex, txt, 
               _attributeNameSplitters, out currentChar);
         ...
         case NodeScanState.AttributeNameRead:
            ...
            GetUntilAny(ref currentIndex, txt, _attributeValueEnders);
            scanState = NodeScanState.AttributeValueRead;
            return true;

         case NodeScanState.EndOfNodeOpen:
            GetUntil(ref currentIndex, txt, '<');
      ...
      readNodeName:
      GetUntilAny(ref currentIndex, txt,  _nodeNameEnders, out currentChar);
