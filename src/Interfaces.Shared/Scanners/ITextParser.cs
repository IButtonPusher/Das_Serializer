...
namespace Das.Serializer
{
    public interface ITextParser : INumberExtractor
    {
        ...
        Boolean AppendAsUsCommaString(StringBuilder sb,
        ...
        String BuildString<T1, T2, T3, T4>(T1 item1,
                                           T2 item2,
                                           T3 item3,
                                           T4 item4);

        String BuildString<T1, T2, T3, T4, T5>(T1 item1,
                                               T2 item2,
                                               T3 item3,
                                               T4 item4,
                                               T5 item5);

        String BuildString<T1, T2, T3, T4, T5, T6>(T1 item1,
                                                   T2 item2,
                                                   T3 item3,
                                                   T4 item4,
                                                   T5 item5,
        ...
        /// <returns></returns>
        Boolean ContainsOrdinal(String checkingString,
                                String value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Boolean EndsWithOrdinal(String checkingString,
                                String value);

        /// <summary>
        ///     Returns all values for the given key
        /// </summary>
        IEnumerable<String> EnumerateJsonValues(String input,
                                                String key);

        Double FindJsonDouble(String input,
                              String toFind);

        String? FindJsonValue(String input,
                              String toFind);

        String? FindJsonValue(String json,
                              String item,
                              ref Int32 startIndex);

        IEnumerator<String?> FindJsonValues(String input,
                                            String toFind1,
                                            String toFind2);
        ...
        IEnumerable<String> FindTextsWithin(String input,
                                            String leftOf,
                                            String rightOf);
        ...
        IEnumerable<String> FindTextWithin(String input,
                                           String[] delimiters);
        ...
        /// </summary>
        Int32 IndexOfEnd(String searchIn,
                         String searchFor);

        Int32 LastIndexOf(String searchIn,
                          String searchFor);
        ...
        String LeftOf(String input,
                      String rightBounds);


        String RemoveAll(String input,
                         String[] toRemove);
        ...
        Boolean TryFindTextSurrounding(String input,
                                       String[] delimiters,
                                       out String[] found,
        ...
        /// </summary>
        /// <returns>delimiters.Length - 1 items</returns>
        Boolean TryFindTextWithin(String input,
                                  String[] delimiters,
                                  out String[] found);

        Boolean TryIndexOf(String searchIn,
                           String searchFor,
                           out Int32 index);

        Boolean TrySkip(String inText,
